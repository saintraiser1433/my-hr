...
<template>
    <UModal v-model:open="openModal" description="Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit, totam architecto! Provident tempore porro ipsa!"  title="View Content" :ui="{ content: 'max-w-6xl' }">
    
    <template #body>
      <div class="flex flex-col flex-wrap gap-2 ">
        <h1 class="font-semibold">Job Title: {{data.title}} </h1>
        <NuxtImg :src="`${config.public.storageURL}/${data.headerImage}`"></NuxtImg>
        <USeparator/>
