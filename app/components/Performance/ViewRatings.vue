        ...
        <template #body>
            <div
                ...
                <div
                    ...
                    <h1
                        class="font-semibold uppercase">{{ fullname }}</h1>
                    <h2
                        class="text-gray-700 dark:text-gray-400 font-semibold capitalize">
                        {{ information }}
                    </h2>
                    <div
                        class="flex flex-col lg:flex-row mt-6 gap-5">
                        <h5
                            class="font-semibold lg:ml-2">Head:</h5>
                        <h5>Cyrus P. Teo</h5>
                        <h5
                            class="font-semibold lg:ml-2">Department:</h5>
                        <h5
                            class="capitalize">{{ department }}</h5>
                        <h5
                            class="font-semibold">Hired date:</h5>
                        <h5>
                            {{ hiredData }}
                        </h5>
                    </div>
            ...
            <div
                class="grid grid-cols-12 gap-3 py-5">
                <div
                    ...
                    <UCard
                        ...
                        <template #header>
                            <div
                                ...
                                <h3
                                    class="font-semibold">Peer Ratings</h3>
                    ...
                    <UCard
                        ...
                        <template #header>
                            <div
                                class="flex flex-col justify-center">
                                <h3
                                    class="font-semibold">Team Lead Ratings</h3>
