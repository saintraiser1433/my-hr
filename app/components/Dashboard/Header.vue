<template>
  <header :class="isToggle ? 'lg:w-[calc(100%-var(--sidebar-compact))] ' : 'lg:w-[calc(100%-var(--sidebar))] '"
    ...
    <div class="flex items-center">
      ...
      |
      <UBreadcrumb class="ml-2" :items="items" :ui="{
        link: 'text-[13px]'
      }" />
    </div>
    <div>
      <ClientOnly v-if="!colorMode?.forced">
        <UButton :icon="isDark ? 'i-lucide-moon' : 'i-lucide-sun'" color="neutral" variant="ghost" class="cursor-pointer"
          @click="isDark = !isDark" />
