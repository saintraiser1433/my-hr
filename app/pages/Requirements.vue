        ...
        async (result) => {
            if (result.isConfirmed) {
                try {
                    ...
                    requirementsData.value = requirementsData.value.filter((item) => item.id !== id);
...
<template>
    ...
    <RequirementsForm @data-requirements="submit" v-model:state="requirementsForm" :title="title" v-model:open="isOpen" />
