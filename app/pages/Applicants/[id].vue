...
<template>
    <!-- <div class="flex items-center justify-center p-1 border-1 bg-(--primary) rounded-full">
            <NuxtImg class="rounded-full" src="profile.jpg" quality="100" height="120" width="120"></NuxtImg>
        </div> -->
    <div class="flex items-center gap-5 pb-2">
        <div class="flex items-center justify-center p-1 ml-5 border-1 bg-(--primary) rounded-full">
            <NuxtImg class="rounded-full" src="profile.jpg" quality="100" height="140" width="140"></NuxtImg>
        </div>
        <div class="flex flex-col gap-1 py-2 w-full">
            <h1 class=" font-(family-name:--font-poppins) uppercase font-semibold">JOHN REY N. DECOSTA</h1>
    ...
    <ApplicantsProgress :data="ongoingData">
    </ApplicantsProgress>
</template>
